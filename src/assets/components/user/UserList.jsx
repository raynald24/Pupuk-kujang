    ...
    <div className="bg-gray-200 min-h-screen p-6">
      ...
      <div className="bg-gradient-to-br from-sky-500 to-sky-600 p-8 rounded-xl shadow-lg mb-8">
        <div className="pb-5">
          ...
          <h2 className="text-gray-200">List of Users</h2>
        </div>
        ...
        <div className="w-full mx-auto flex items-center gap-x-5 mb-4">
          <div className="relative flex-1">
            <input
              ...
              className="block p-2.5 w-full text-sm rounded-md border focus:ring-2 focus:ring-sky-500"
              placeholder="Search Name, Email, Role"
            />
            <button
              type="button"
              onClick={handleSearch} // Fungsi pencarian dipanggil saat tombol klik
              className="absolute top-0 right-0 p-2.5 text-sm font-medium h-full text-white bg-sky-700 rounded-md"
            >
              Search
            </button>
          </div>
        ...
        <table className="min-w-full table-auto bg-white text-black shadow-md">
          ...
          <tbody>
            {currentPageData.map((user, index) => (
              <tr key={user.uuid} className="border-t text-center">
      ...
      <div className="flex justify-center mt-4">
        <button
          ...
          className="px-5 py-2 text-white bg-sky-500 rounded-md hover:bg-sky-600 disabled:bg-gray-400"
